"""
CoreWeave Sandbox (aviato) launcher.

Implements :class:`SandboxLauncher` for `CoreWeave Sandbox
<https://www.cwsandbox.com>`_ on top of the official ``cwsandbox`` Python
SDK (gRPC under the hood). Same posture as the Modal and Daytona
